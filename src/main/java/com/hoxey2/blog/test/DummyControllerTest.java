...
public class DummyControllerTest {
	...
	public String delete(@PathVariable int id) {
		...
		} catch (EmptyResultDataAccessException e) { // 예외 처리
	...
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) { // RequestBody는 json 데이터를 요청 => Java Object(MessageConverter의 Jackson)로 변환해서 받아줌/
